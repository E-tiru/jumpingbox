...
var game = cc.Layer.extend({
    init:function () {
        ...
        //this.addBody(250,32,24,24,false,res.brick1x1_png,SpriteTag.destroyable);
        ...
        this.addBody(96,64,96,48,true,res.brick4x2_png,SpriteTag.solid);
        this.addBody(48,32,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(96,32,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(144,32,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(192,32,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(240,32,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(288,32,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(336,32,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(384,32,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(432,32,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(240,188,33,32,true,res.totem_png,SpriteTag.totem);
        this.addBody(96,176,48,18,true,res.gool_png,SpriteTag.gool);
        //this.addBody(240,32,500,20,false,res.ground_png,SpriteTag.destroyable);
    ...
    update:function(dt){
        ...
        for (var i = 0; i < shapeArray.length; i++) {
         ...
         leveltext = cc.LabelTTF.create("Level : "+ level,"Arial",12);
         leveltext.setPosition(size.width *0.1, size.height*2);
         topLayer.addChild(leveltext,1);
         topLayer.removeChild(scoretext);
         scoretext = cc.LabelTTF.create("Score : "+ score,"Arial",12);
         scoretext.setPosition(size.width *0.27, size.height*2);
         topLayer.addChild(scoretext,1);
         topLayer.removeChild(bonustext);
         bonus-=1;
         bonustext = cc.LabelTTF.create("Bonus : "+ bonus,"Arial",12);
         bonustext.setPosition(size.width *0.5, size.height*2);
         topLayer.addChild(bonustext,1);
         topLayer.removeChild(jumptext);
         jumptext = cc.LabelTTF.create("Jumps : "+ shot,"Arial",12);
         jumptext.setPosition(size.width *0.8, size.height*2);
